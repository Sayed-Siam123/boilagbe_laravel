...
<div class="section" style="padding: 5px;">
    <div class="container">
        ...
        <div class="row col-md-13">
            ...
            <form id="myForm" action="user_update_profile_info.php" onsubmit="validation()" method="post">


                      <h3>"tai naki?"</h3>
                      <h6>"msiam18@gmail.com"</h6>
                      <h4>Update User Information</h4><br>

                      <div class="form-group">
                              <label for="location">Location</label>
                              <input type="text" class="form-control input-sm" name="user_location" placeholder="dadad" required>
                      </div>
                      <div class="form-group">
                              <label for="phoneNumber">Phone Number</label>
                              <input type="text" class="form-control input-sm" name="user_phonenumber" placeholder=".$row['user_phone_number']." required >
                      </div>

                      <div class="form-group">
                              <label for="password">Password</label>
                              <input type="password" class="form-control input-sm" name="user_password" id="user_password" placeholder=".$row['user_password']."  required>
                      </div>
                     <div class="fom-group">
